...
parser.add_argument("--atlas", help='Define atlas.', type=str, default = 'AAL3')
parser.add_argument("--seed", help='Define seed ROI.', type=str, default = 'Occipital_Mid_L')
parser.add_argument("--target", help='Define target ROI.', type=str, default = 'Amygdala_L')
